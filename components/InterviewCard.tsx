...
const InterviewCard = ({interviewId,
  ...
  return (
    <>
    <div className="card-border w-[360px] max-sn:w-full min-h-96">
    <div className="card-Interview relative p-5 rounded-xl overflow-hidden">
        <div>
        ...
        <div className="mt-8 flex flex-row justify-between items-center">
          <div className="flex items-center">
            ...
            {/* Here you would render your DisplayTechIcons component */}
